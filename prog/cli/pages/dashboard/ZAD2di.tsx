...
const DashboardProfilePage: NextPage<Props> = ({ userData }) => {
  ...
  return (
    ...
    >
      <div className="text-[#000000] text-3xl font-semibold text-left font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight absolute left-10 top-3 flex items-center justify-start">
        Основы Figma{" "}
      </div>
      ...
      <div className="text-[#000000] text-left font-desktopbl-font-family text-desktopbl-font-size font-desktopbl-font-weight absolute left-10 top-[85px] w-[654px] flex items-center justify-start">
        Здесь вы научитесь основам программы Figma. Сперва посмотрите
        мастер-классы, а после приступите к выполнению заданий.{" "}
      </div>
      <div className="bg-[#B328F6] rounded-[20px] p-6 flex flex-row gap-2.5 items-center justify-center absolute left-10 top-[153px]">
