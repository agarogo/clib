...
const DashboardProfilePage: NextPage<Props> = ({ userData }) => {
  ...
  return (
    <div
      className={
        "bg-[#ffffff] w-[1280px] h-[1212px] relative overflow-hidden "
      }
    >
        <form action="/dashboard/ZAD1">
            <button>
                <div className="rounded-[20px] border-solid border-[#000000] border pt-2.5 pr-5 pb-2.5 pl-5 flex flex-row gap-2.5 items-center justify-center absolute left-[43px] top-[1052px]">
                    <svg
      ...
      <div className="bg-foundation-black-black-13 rounded-[20px] pt-2.5 pr-5 pb-2.5 pl-5 flex flex-row gap-2.5 items-center justify-center absolute left-[178px] top-[1152px]">
      ...
      <div className="absolute" style={{ inset: "0" }}>
        <div
          className="rounded-[20px] w-80 h-80 absolute left-[43px] top-4 www"
          
        />
        <div
          className="rounded-[20px] w-80 h-80 absolute left-[383px] top-4 www1"

        />
        <div
          className="rounded-[20px] w-80 h-80 absolute left-[723px] top-4 www2"

        />
        <div
          className="rounded-[20px] w-80 h-80 absolute left-[43px] top-[352px] www4"

        />
        <div
          className="rounded-[20px] w-80 h-80 absolute left-[383px] top-[352px] www3"

        />
      </div>
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[696px]">
        <div className="text-[#000000] text-2xl font-semibold text-left font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          01{" "}
        </div>
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[744px]">
        <div className="text-[#000000]  text-2xl font-semibold text-left font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          02{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[792px]">
        <div className="text-[#000000] text-left text-2xl font-semibold  font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          03{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
          <div className="text-foundation-black-black-6 text-left font-buttonmedium-font-family text-buttonmedium-font-size font-buttonmedium-font-weight relative flex-1 flex items-center justify-start">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[840px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          04{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[888px]">
        <div className="text-[#000000] text-left text-2xl font-semibold  font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          05{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[936px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          06{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-10 top-[984px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          07{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[696px]">
        <div className="text-[#000000] text-left text-2xl font-semibold  font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          08{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[744px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          09{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[792px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          10{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[840px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          11{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[888px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          12{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[936px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          13{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
      ...
      <div className="flex flex-row gap-3 items-center justify-start absolute left-[417px] top-[984px]">
        <div className="text-[#000000] text-left  text-2xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight relative flex items-center justify-start">
          14{" "}
        </div>
        <div className="bg-white rounded-[20px] border-solid border-foundation-black-black-6 border pt-2.5 pr-4 pb-2.5 pl-4 flex flex-row gap-2 items-center justify-start shrink-0 w-[260px] relative">
