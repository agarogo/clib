...
const DashboardProfilePage: NextPage<Props> = ({ userData }) => {
  ...
  return (
    <div
      className={
        "bg-[#ffffff] w-[1280px] h-[580px] relative overflow-hidden "
      }
    >
      <div className="text-[#000000] text-left text-3xl font-semibold font-desktopsub-font-family text-desktopsub-font-size font-desktopsub-font-weight absolute left-10 top-3 flex items-center justify-start">
        Кроссворд МПИТ{" "}
      </div>
      <div className="text-[#000000] font-semibold text-left font-desktoppre-font-family text-desktoppre-font-size font-desktoppre-font-weight uppercase absolute left-10 top-[54px] flex items-center justify-start">
        от МПИТ{" "}
      </div>
      <div className="text-[#000000] text-left font-desktopbl-font-family text-desktopbl-font-size font-desktopbl-font-weight absolute left-10 top-[85px] w-[654px] flex items-center justify-start">
        Вы уже знаете как проведете свой выходной? Сегодня мы подготовили
        воскресный кроссворд, который проверит ваши знания о конкурсе «Моя
        профессия — ИТ»! Ключевое слово — главное направление хакатона,
        помогающее молодежи определиться с будущей профессией{" "}
      </div>
      <div className="bg-[#B328F6] rounded-[20px]  p-6 flex flex-row gap-2.5 items-center justify-center absolute left-10 top-[197px]">
        <div className="text-white font-semibold text-2xl text-left font-desktoph-2-font-family text-desktoph-2-font-size font-desktoph-2-font-weight relative flex items-center justify-start">
          10 A{" "}
        </div>
      </div>
      <form action="/dashboard/ZAD">
        <button className="rounded-[20px] border-solid border-[#000000] border pt-2.5 pr-5 pb-2.5 pl-5 flex flex-row gap-2.5 items-center justify-center absolute left-[45px] top-[524px]">
          <svg
      ...
      <form action="/dashboard/ZAD1k">
        <button className="bg-black rounded-[20px] pt-2.5 pr-5 pb-2.5 pl-5 flex flex-row gap-2.5 items-center justify-center absolute left-[180px] top-[524px]">
